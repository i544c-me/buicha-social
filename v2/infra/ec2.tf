...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250618-kernel-6.1-arm64
  image_id = "ami-03430a7937a154e07"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250618-kernel-6.1-x86_64
  image_id = "ami-03b47a7a2bd82b8e9"
