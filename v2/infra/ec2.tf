...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20251217-kernel-6.1-arm64
  image_id = "ami-09d39c7464c3ec7df"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20251217-kernel-6.1-x86_64
  image_id = "ami-007ce1f88260d5e59"
