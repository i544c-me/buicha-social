...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250812-kernel-6.1-arm64
  image_id = "ami-027c889f4ea4e8ce5"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250812-kernel-6.1-x86_64
  image_id = "ami-0ddbbe422c8bf7886"
