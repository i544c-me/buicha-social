...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20260307-kernel-6.1-arm64
  image_id = "ami-0a1006d0be402e290"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20260307-kernel-6.1-x86_64
  image_id = "ami-00affe9a60133a99b"
