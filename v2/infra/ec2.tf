...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20241031-kernel-6.1-arm64
  image_id = "ami-010fc17871c820993"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20241031-kernel-6.1-x86_64
  image_id = "ami-0fb70df3c97fdfc7f"
