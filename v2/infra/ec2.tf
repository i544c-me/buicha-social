...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250610-kernel-6.1-arm64
  image_id = "ami-066ebc0f53f2e253f"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250610-kernel-6.1-x86_64
  image_id = "ami-03a959e9cf30c4b15"
