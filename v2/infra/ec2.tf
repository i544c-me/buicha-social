...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20260922-kernel-6.1-arm64
  image_id = "ami-0062b1f533f65434a"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20260922-kernel-6.1-x86_64
  image_id = "ami-08d556eca88f9a61c"
