...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250206-kernel-6.1-arm64
  image_id = "ami-0b1ddf3b2ec659a5d"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250206-kernel-6.1-x86_64
  image_id = "ami-0c0ca60dcad8fe10c"
