...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250721-kernel-6.1-arm64
  image_id = "ami-0f34b7f4096b79a8a"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250721-kernel-6.1-x86_64
  image_id = "ami-0d44e423638d21471"
