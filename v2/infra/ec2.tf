...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20240809-kernel-6.1-arm64
  image_id = "ami-04c630bae9dbba70f"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20240809-kernel-6.1-x86_64
  image_id = "ami-0a9d6be36a45666cc"
