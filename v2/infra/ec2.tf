...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250828-kernel-6.1-arm64
  image_id = "ami-08adfc876ed9fe809"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250828-kernel-6.1-x86_64
  image_id = "ami-00f925a1497d4b647"
