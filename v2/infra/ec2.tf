...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20251027-kernel-6.1-arm64
  image_id = "ami-0fa07fb749574be0e"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20251027-kernel-6.1-x86_64
  image_id = "ami-039c76adc4655ddc2"
