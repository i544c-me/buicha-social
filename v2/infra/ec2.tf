...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250916-kernel-6.1-arm64
  image_id = "ami-05af7e9c2fd980fe7"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250916-kernel-6.1-x86_64
  image_id = "ami-0925d63721690c5b8"
