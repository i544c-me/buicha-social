...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250310-kernel-6.1-arm64
  image_id = "ami-0c522623e131c47e1"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20250310-kernel-6.1-x86_64
  image_id = "ami-0680737432bba0926"
