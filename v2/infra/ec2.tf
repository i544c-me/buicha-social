...
resource "aws_launch_template" "runner_v2_arm64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20260414-kernel-6.1-arm64
  image_id = "ami-05f5ddb932bf0bd31"
...
resource "aws_launch_template" "runner_v2_x86_64" {
  ...
  # currentImageName=al2023-ami-ecs-hvm-2023.0.20260414-kernel-6.1-x86_64
  image_id = "ami-07b6834a86f3632c8"
